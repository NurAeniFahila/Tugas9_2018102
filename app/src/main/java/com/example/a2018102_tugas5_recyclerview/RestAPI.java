...
import com.example.a2018102_tugas5_recyclerview.databinding.ActivityRestApiBinding;
...
public class RestAPI extends AppCompatActivity implements
    ...
    public void getData() throws MalformedURLException {
        Uri uri = Uri.parse("http://dev.farizdotid.com/api/daerahindonesia/provinsi")
                .buildUpon().build();
    ...
    class DOTask extends AsyncTask<URL, Void, String>{
        ...
        public void parseJson(String data) throws JSONException{
            ...
            try {
                ...
                Log.d("TAG", "parseJson: "+data);
            }catch (JSONException e){
                e.printStackTrace();
            }
            JSONArray cityArray = jsonObject.getJSONArray("provinsi");
            for (int i =0; i <cityArray.length(); i++){
                ...
                if (Sobj.equals(index)){
                    ...
                    binding.resultCreated.setText(nama);
                    break;
                }
            }
        }
